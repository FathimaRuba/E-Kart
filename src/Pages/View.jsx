     ...
     <section className="py-5">
            {
                ...
                <div className="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div className="col-md-6">
                        {/* <div className="small mb-1">{data?.id}</div> */}
                        ...
                        <div className="d-flex justify-content-between">
                            ...
                            <button className="btn btn-outline-dark flex-shrink-0" type="button" onClick={handleWish}>
                            <i className="fa-solid fa-heart-circle-plus me-2" style={{color: "#c93b3b",}} />
                                Add to Wishlist
                            </button>
                        </div>
                    </div>
